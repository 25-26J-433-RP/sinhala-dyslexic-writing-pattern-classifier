...
def analyze_essay(essay_text: str, threshold: float = 0.65) -> dict:
    ...
    # Conservative: BOTH score AND ratio must be high to call DYSLEXIC
    # Prevents false positives on normal essays
    if composite_score >= 0.75 and dyslexic_ratio >= 0.40:
        essay_label = "DYSLEXIC ESSAY"
    elif composite_score >= 0.63:
